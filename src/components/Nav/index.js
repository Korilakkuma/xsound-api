            ...
            <nav role="tablist" aria-multiselectable="false" className={Nav.CLASS_NAME}>
                ...
                <section role="presentation">
                    ...
                    <dl id="panel-audio" aria-hidden={expandedPanelId !== 'panel-audio'}>
                        ...
                        <dd><Link to={`${this.path}audio/sprite`} className={this.getSelectedClassName(`${this.path}audio/sprite`)}>sprite</Link></dd>
                    </dl>
                </section>
                <section role="presentation">
                ...
                <section role="presentation">
                    ...
                    <dl id="panel-effectors" aria-hidden={expandedPanelId !== 'panel-effectors'}>
                        ...
                        <dd><Link to={`${this.path}effectors/listener-and-panner`} className={this.getSelectedClassName(`${this.path}effectors/listener-and-panner`)}>listener / panner</Link></dd>
                        <dd><Link to={`${this.path}effectors/stereo`} className={this.getSelectedClassName(`${this.path}effectors/stereo`)}>stereo</Link></dd>
