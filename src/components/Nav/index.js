      ...
      <nav role="tablist" aria-multiselectable="false" className={Nav.CLASS_NAME}>
        ...
        <section role="presentation">
          ...
          <dl id="panel-noise" aria-hidden={expandedPanelId !== 'panel-noise'}>
            <dt>Interfaces</dt>
            <dd><Link to={`${BASS_PATH}noise/interface`} className={this.getSelectedClassName(`${BASS_PATH}noise/interface`)}>NoiseModule</Link></dd>
            <dt>Methods</dt>
        ...
        <section role="presentation">
          ...
          <dl id="panel-processor" aria-hidden={expandedPanelId !== 'panel-processor'}>
            ...
            <dd><Link to={`${BASS_PATH}processor/ready`} className={this.getSelectedClassName(`${BASS_PATH}processor/ready`)}>ready</Link></dd>
            ...
            <dd><Link to={`${BASS_PATH}processor/on-message-error`} className={this.getSelectedClassName(`${BASS_PATH}processor/on-message-error`)}>onMessageError</Link></dd>
            <dd><Link to={`${BASS_PATH}processor/map`} className={this.getSelectedClassName(`${BASS_PATH}processor/map`)}>map</Link></dd>
            <dd><Link to={`${BASS_PATH}processor/param`} className={this.getSelectedClassName(`${BASS_PATH}processor/param`)}>param</Link></dd>
            <dd><Link to={`${BASS_PATH}processor/get`} className={this.getSelectedClassName(`${BASS_PATH}processor/get`)}>get</Link></dd>
          </dl>
        </section>
        <section role="presentation">
        ...
        <section role="presentation">
          ...
          <dl id="panel-mml" aria-hidden={expandedPanelId !== 'panel-mml'}>
            <dt>Interfaces</dt>
            <dd><Link to={`${BASS_PATH}mml/interface`} className={this.getSelectedClassName(`${BASS_PATH}mml/interface`)}>MML</Link></dd>
            <dt>Methods</dt>
        ...
        <section role="presentation">
          ...
          <dl id="panel-session" aria-hidden={expandedPanelId !== 'panel-session'}>
            <dt>Interfaces</dt>
            <dd><Link to={`${BASS_PATH}session/interface`} className={this.getSelectedClassName(`${BASS_PATH}session/interface`)}>Session</Link></dd>
            <dt>Methods</dt>
