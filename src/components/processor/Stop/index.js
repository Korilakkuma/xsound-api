        ...
        return (
            <main className={Stop.CLASS_NAME}>
                ...
                <section className="codepen">
                    <iframe height='265' scrolling='no' title='ProcessorModule#stop | XSound - Web Audio API Library -' src='//codepen.io/Korilakkuma/embed/drjLdP/?height=265&amp;theme-id=0&amp;default-tab=js,result&amp;embed-version=2' frameBorder='no' allowTransparency='true' allowFullScreen='true' style={{ width : '100%' }}>See the Pen <a href='https://codepen.io/Korilakkuma/pen/RBXMBy/'>ProcessorModule#stop | XSound - Web Audio API Library -</a> by Tomohiro IKEDA (<a href='https://codepen.io/Korilakkuma'>@Korilakkuma</a>) on <a href='https://codepen.io'>CodePen</a>.
</iframe>
                </section>
            </main>
        );
