...
const render = Component => ({ history, match }) => {
    ...
    if (Component.TITLE === 'Home') {
        document.title = 'XSound - Web Audio API Library for Synthesizer, Effects, Visualization, Recording ... -';
    } else {
        document.title = `${Component.TITLE} | XSound - Web Audio API Library for Synthesizer, Effects, Visualization, Recording ... -`;
    }
